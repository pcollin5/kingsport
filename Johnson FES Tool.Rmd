...
johnson_poverty_tracts <- Johnson_dp03_18 %>%
...
trimmed_tract_u5_poverty_18 <- johnson_poverty_tracts[,c(2,4,5)]
...
johnson_u5_tract_map <- mapview(trimmed_tract_u5_poverty_18, zcol = "Percent", layer.name = "<5 % in Poverty", legend = TRUE)

johnson_u5_tract_map
