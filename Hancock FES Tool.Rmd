...
hancock_poverty_tracts <- Hancock_dp03_18 %>%
...
trimmed_tract_u5_poverty_18 <- hancock_poverty_tracts[,c(2,4,5)]
...
hancock_u5_tract_map <- mapview(trimmed_tract_u5_poverty_18, zcol = "Percent", layer.name = "<5 % in Poverty", legend = TRUE)

hancock_u5_tract_map
