...
carter_poverty_tracts <- Carter_dp03_18 %>%
...
trimmed_tract_u5_poverty_18 <- carter_poverty_tracts[,c(2,4,5)]
...
carter_u5_tract_map <- mapview(trimmed_tract_u5_poverty_18, zcol = "Percent", layer.name = "Under 5 Years of Age Percent in Poverty", legend = FALSE)
