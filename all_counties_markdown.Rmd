---
title: "Demographic, Social, Economic, and Housing Characteristics for Upper East Tennessee"
author: "Paul Collins"
...
```{r households data tables, echo = FALSE}
...
```{r highschool degree map, echo = FALSE}
...
```{r disability data table, echo = FALSE}
...
```{r residency data tables, echo = FALSE}
...
```{r birthplace data table, echo = FALSE}
...
```{r language spoken at home data table, echo = FALSE}
...
```{r computer data table, echo = FALSE}
...
```{r broadband internet map, echo = FALSE}
...
```{r workers transportation data table, echo = FALSE}
...
```{r mean commute time, echo = FALSE}
...
```{r public transportation use by workers map, echo = FALSE}
...
```{r service occupation map, echo = FALSE}
...
```{r industry type data tables, echo = FALSE}
...
```{r median household income map, echo = FALSE}
...
```{r mean household income map, echo = FALSE}
...
```{r income below 10,000, echo = FALSE}
...
```{r social security map, echo = FALSE}
...
```{r chas assistance map, echo = FALSE}
...
```{r no health insurance map, echo = FALSE}
...
```{r public health insurance, echo = FALSE}
...
```{r proverty data tables, echo = FALSE}
    # poverty
...
```{r under 5 poverty map, echo = FALSE}
...
```{r all people in poverty, echo = FALSE}
...
```{r transportation per housing unit data tables, echo = FALSE}
...
```{r no transportation per housing unit map, echo = FALSE}
    ...
    zero_vehicles_map <- mapview(list(zero_vehicles_county, zero_vehicles_tract),
                                 zcol = list("Percent", "Percent"),
                                 layer.name = list("Percent of Occupied Housing Units with Zero Vehicles Available County", "Percent of Occupied Housing Units with Zero Vehicles Available Tract"),
                                 legend = list(FALSE, TRUE))
