...
```{r vehicles per housing units data tables, echo = FALSE}
...
```{r zero vehicles per housing units map, echo = FALSE}
...
```{r heating data tables, echo = FALSE}
