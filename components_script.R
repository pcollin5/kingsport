...
counties_pop <- rbind( Carter_pop, Greene_pop, Hawkins_pop, Hancock_pop, Johnson_pop, Sullivan_pop, Washington_pop, Unicoi_pop)
combined_pop <- rbind(Tennessee_pop, Carter_pop, Greene_pop, Hawkins_pop, Hancock_pop, Johnson_pop, Sullivan_pop, Washington_pop, Unicoi_pop)

mapview(combined_pop, zcol = "NAME", layer = "NAME")

Carter_pop$Name = "Carter"
Greene_pop$Name = "Greene"
Hawkins_pop$Name = "Hawkins"
Hancock_pop$Name = "Hancock"
Johnson_pop$Name = "Johnson"
Sullivan_pop$Name = "Sullivan"
Washington_pop$Name = "Washington"
Unicoi_pop$Name = "Unicoi"
Tennessee_pop$Name = "TN"

counties_pop <- rbind( Carter_pop, Greene_pop, Hawkins_pop, Hancock_pop, Johnson_pop, Sullivan_pop, Washington_pop, Unicoi_pop)

combined_pop <- rbind(Tennessee_pop, Carter_pop, Greene_pop, Hawkins_pop, Hancock_pop, Johnson_pop, Sullivan_pop, Washington_pop, Unicoi_pop)

tn_big_map <-mapview(combined_pop, zcol = "Name", layer.name = "UETHDA Counties", legend = FALSE)

counties_map <- mapview(counties_pop, zcol = "Name", layer.name = "UETHDA Counties")
